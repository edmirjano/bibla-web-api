                    ...
                    <form method="POST"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div id="coverDropzone" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 flex items-center justify-center cursor-pointer relative"
                                    ...
                                    <input id="cover" class="hidden" type="file" name="cover" accept="image/*" required autofocus onchange="previewImage(event)" />

                                    <!-- Preview for the current image -->
{{--                                    <div id="imagePreview" class="absolute inset-0 flex items-center justify-center"></div>--}}
                                </div>
                                @error('cover')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
