            ...
            <div class="flex flex-col">
                ...
                <div class="space-y-2">
                    <button @click="openBooks = !openBooks" class="flex items-center w-full">
                        ...
                        <svg x-bind:class="{'rotate-180': openBooks}" class="w-4 h-4 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
                ...
                <div class="space-y-2">
                    <button @click="openSongs = !openSongs" class="flex items-center w-full">
                        ...
                        <svg x-bind:class="{'rotate-180': openSongs}" class="w-4 h-4 transform transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
